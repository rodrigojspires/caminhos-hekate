...
const ThresholdsSchema = z.object({
  ...
  survivalDeepMaxHouse: z.number().int().min(0).max(999).nullable().optional(),
  survivalBroadMaxHouse: z.number().int().min(0).max(999).nullable().optional(),
  survivalWindowMoves: z.number().int().min(0).max(999).nullable().optional(),
  survivalDeepCount: z.number().int().min(0).max(999).nullable().optional(),
  survivalBroadCount: z.number().int().min(0).max(999).nullable().optional(),
  survivalConsecutiveMaxHouse: z.number().int().min(0).max(999).nullable().optional(),
  survivalConsecutiveCount: z.number().int().min(0).max(999).nullable().optional(),
  survivalIgnoreInitialMoves: z.number().int().min(0).max(999).nullable().optional(),
  survivalPersistenceWindowMoves: z.number().int().min(0).max(999).nullable().optional(),
  survivalPersistenceMaxHouse: z.number().int().min(0).max(999).nullable().optional(),
  survivalPersistenceCount: z.number().int().min(0).max(999).nullable().optional(),
  rapidRollWindowMoves: z.number().int().min(0).max(999).nullable().optional(),
  rapidRollMaxAvgSeconds: z.number().int().min(0).max(999).nullable().optional(),
  fastAscentWindowMoves: z.number().int().min(0).max(999).nullable().optional(),
  fastAscentMinCount: z.number().int().min(0).max(999).nullable().optional(),
  fastAscentMinDelta: z.number().int().min(0).max(999).nullable().optional(),
  checkpointEveryMoves: z.number().int().min(0).max(999).nullable().optional(),
})
...
function normalizeThresholds(value: unknown) {
  ...
  const keys = [
    ...
    'survivalConsecutiveCount',
    'survivalIgnoreInitialMoves',
    'survivalPersistenceWindowMoves',
    'survivalPersistenceMaxHouse',
    'survivalPersistenceCount',
